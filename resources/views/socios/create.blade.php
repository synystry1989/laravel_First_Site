                ...
                <div class="card">
                    ...
                    <div id="table1" class="card-body">
                        <form action="{{route('socio.store')}}" method="post">
                            ...
                            <div class="input-container">
                                <i class="icon"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512"><!--!Font Awesome Free 6.5.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
                                ...
                                <input class="input-field" type="text" placeholder="codigo Postal" name="codigo_Postal" id="codigo_Postal">
                            </div>
