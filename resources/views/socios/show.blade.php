...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div style ="text-align:center;font-weight:bold " class="card-header">Detalhes do Socios
                        {{ $socio->nome }}</div>
                    ...
                    <div class="card-body">
                        <div>
                            ...
                            <td><a href="{{ route('socio.edit', $socio->id) }}"class="btn btn-warning">Editar</a>


                            </td>
                            <td><a href="{{ route('socio.confirma_delete', $socio->id) }}"class="btn btn-danger">Apagar</a>
                            </td>

                            {{-- <td><a href="{{ route('socio.destroySocio', $socio->id) }}"class="btn btn-danger">Apagar</a> --}}
                            </td>
