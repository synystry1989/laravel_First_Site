          ...
          <table class="table">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td ><a href="{{route('socio.show_all',$socio->id )}}" id="botoes" class="btn btn-success"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-eye-fill" viewBox="0 0 16 16">
