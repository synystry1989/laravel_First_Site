      ...
      <div id="table1" class="card">
        ...
        <div class="card-body">
          ...
          <div class="input-group mb-3">
            ...
            <input type="text" class="form-control" placeholder="Meus Socios">
          ...
          <table class="table">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><a href="{{route('socio.show',$socio->id )}}" id="botoes" class="btn btn-success"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="color:black" class="bi bi-eye-fill" viewBox="0 0 16 16">
